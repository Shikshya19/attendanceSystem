...
namespace AttendanceSystem.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Auther,PublishDate")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Auther,PublishDate")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
